...
class EGraphable{
  public:
    ...
    //Added for multiagent planning
    //virtual int GetNumGoals() const{return 0;};
    //virtual int GetNumAgents() const{return 0;};
    virtual bool isValidEdge(int agentID, const std::vector<double>& coord, const std::vector<double>& coord2, bool& change_cost, int& cost){return false;};
    virtual bool isValidVertex(int agentID, const std::vector<double>& coord){return false;};
